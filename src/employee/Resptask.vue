<template>
  <div>
    <el-card>
      <el-row>
        <el-card v-if="taskBean.subTaskState!==2">
          <el-input placeholder="请外包员工id" v-model="outtaskmanid">
            <template slot="prepend" style="width: 440px">
              <el-date-picker style="width: 440px"
              v-model="value"
              type="datetimerange"
            ...
            <template slot="suffix" >
              <el-button type="success" style="height: 40px"  @click="outpack">
                申请外包
              </el-button>
            </template>
          </el-input>
...
<!--    </el-dialog>-->
    <el-dialog
      ...
      <el-upload
        drag
        :data="uploaddata"
        action="http://192.168.43.164:8080/upload/"
